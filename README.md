...
[![Unity 6000.5.5f1](https://img.shields.io/badge/Unity-6000.5.5f1-black.svg)](ProjectSettings/ProjectVersion.txt)
...
> Latest is `0.7.0`. Pin `0.2.1` or later — tags `v0.1.0` / `v0.2.0` are broken (missing `Runtime/Services/Log/` from a `.gitignore` collision); see the [CHANGELOG](CHANGELOG.md) `0.2.1` entry.
...
2. **Open** in Unity 6000.5.5f1 (matching `ProjectSettings/ProjectVersion.txt`). Do not let Unity upgrade the project on a different LTS.
